# Generated by Django 4.0 on 2022-01-24 12:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user', '0005_alter_askerprofile_city_alter_askerprofile_grade_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='askerprofile',
            name='grade',
            field=models.CharField(choices=[('10', '10'), ('11', '11')], default='11', max_length=2),
        ),
        migrations.AlterField(
            model_name='askerprofile',
            name='last_name',
